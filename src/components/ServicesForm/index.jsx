    ...
    try {
      ...
      formattedList.forEach((item) => {
        if (
          ...
          parsedHTML += `<p style="color: rgb(180, 36, 1); text-transform: uppercase; font-size: 1rem;">${item.label}: <span style="font-size: 1.25rem; text-transform: capitalize;">${item.emailData}</span><p/><br/>`;
        }
      });
      parsedHTML +=
