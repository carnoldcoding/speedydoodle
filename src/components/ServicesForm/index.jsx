    ...
    try {
      ...
      formattedList.forEach((item) => {
        if (
          ...
          parsedHTML += `<p style="text-transform: uppercase; font-weight: 600; font-size: 1.25rem;">${item.label}: <span style="font-size: 1.25rem; text-transform: capitalize;">${item.emailData}</span><p/>`;
        }
      });
      parsedHTML +=
